  ...
  return (
    <div className="bg-black container mx-auto px-4">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-5 pb-10">
        ...
        <div className="aspect-w-1 aspect-h-1">
          <img className="object-cover rounded-lg" src="https://res.cloudinary.com/dko9vskvn/image/upload/v1710870472/Screenshot_2024-03-19_at_10.44.39_AM_f2te4y.png" alt=""/>
        </div>
        <div className="aspect-w-1 aspect-h-1">
        ...
        <div className="aspect-w-1 aspect-h-1">
          <img className="object-cover rounded-lg" src="https://res.cloudinary.com/dko9vskvn/image/upload/v1743018073/kauai_v0zuqi.jpg" alt=""/>
        </div>
        <div className="aspect-w-1 aspect-h-1">
